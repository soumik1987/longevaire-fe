...
import { fetchProgramByName, fetchRelatedPrograms } from '../api/programdetailsapi';
...
const ProgramDetailsPage: React.FC = () => {
      ...
      try {
        ...
        if (foundProgram) {
          ...
          try {
            ...
            console.error('Failed to load related programs:', relatedError);
            setError('Could not load related programs. Showing available content.');
            setRelatedPrograms([]);
          }
        } else {
          navigate('/explore');
  ...
  if (loading) {
    return (
      <div className="program-details-page">
        <div className="program-details-loading-container">
          <div className="program-details-loading-spinner"></div>
  ...
  if (!program) {
    return (
      <div className="program-details-page">
        {error && (
          <div className="program-details-error-banner">
            {error}
          </div>
        )}
        <div className="program-details-not-found">
          <h3>Program not found</h3>
          <button onClick={() => navigate('/explore')} className="back-to-explore-btn">
            Back to Explore
          </button>
        </div>
      </div>
