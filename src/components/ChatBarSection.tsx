      ...
      <div className="chatbarsection-content">
        ...
        <form onSubmit={handleSubmit} className="chatbar-input-form">
          <div className="chatbarsection-input-bar">
            <div className="chatbarsection-attach-container">
              <button 
                type="button" 
                className={`chatbarsection-plus-btn ${showAttachMenu ? 'active' : ''}`}
                onClick={(e) => {
                  e.stopPropagation();
                  handlePlusClick();
                }}
              ...
              {showAttachMenu && (
                <div className="chatbarsection-attach-menu">
                  <button
                    type="button"
                    className="chatbarsection-attach-option"
            ...
            <input
              ...
              className={`chatbarsection-text-input ${isRecording ? 'recording' : ''}`}
            />
            
            <button 
              type="button" 
              className={`chatbarsection-mic-btn ${isRecording ? 'recording' : ''}`}
            ...
            <button type="submit" className="chatbarsection-send-btn" disabled={!message.trim()}>
              <Send size={20} />
            </button>
          </div>
        </form>
