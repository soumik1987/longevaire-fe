...
//                 <>
//                   <h1 className="auth-modal-title">Hello!</h1>
//                   <p className="auth-modal-subtitle">Sign in to plan your stay.</p>
...
//                     />
//                     {error && <div className="auth-error-message">{error}</div>}
//                     <button type="submit" disabled={loading} className="auth-verification-button">
//                       {loading ? 'SIGNING IN...' : 'SIGN IN'}
//                     </button>
//                   </form>
...
//                     <div className="auth-test-accounts">
//                       <p><strong>Test Accounts:</strong></p>
//                       <p><button onClick={() => handleTestAccount('test@facility.com')}>test@facility.com</button> / password</p>
//                       <p><button onClick={() => handleTestAccount('test@user.com')}>test@user.com</button> / password</p>
//                       <p><button onClick={() => handleTestAccount('test@admin.com')}>test@admin.com</button> / password</p>
//                     </div>
//                   </div>
//                 </>
//               ) : (
//                 <>
//                   <h1 className="auth-modal-title">Welcome!</h1>
//                   <p className="auth-modal-subtitle">Create your account to begin.</p>

//                   <form onSubmit={handleSignUpSubmit} className="auth-form">
//                     <input type="text" name="firstName" value={signUpData.firstName} onChange={e => handleChange(e, true)} required placeholder="First Name" />
//                     <input type="text" name="lastName" value={signUpData.lastName} onChange={e => handleChange(e, true)} required placeholder="Last Name" />
//                     <input type="email" name="email" value={signUpData.email} onChange={e => handleChange(e, true)} required placeholder="Email" />
//                     <input type="tel" name="phone" value={signUpData.phone} onChange={e => handleChange(e, true)} required placeholder="Phone" />
//                     <select name="role" value={signUpData.role} onChange={e => handleChange(e, true)} required>
//                       <option value="user">Program Creator</option>
//                       <option value="facility">Facility Owner</option>
//                       <option value="admin">Administrator</option>
//                     </select>
//                     <input type="password" name="password" value={signUpData.password} onChange={e => handleChange(e, true)} required placeholder="Password" />
//                     <input type="password" name="confirmPassword" value={signUpData.confirmPassword} onChange={e => handleChange(e, true)} required placeholder="Confirm Password" />
//                     {error && <div className="auth-error-message">{error}</div>}
//                     <button type="submit" disabled={loading} className="auth-verification-button">
//                       {loading ? 'CREATING ACCOUNT...' : 'CREATE ACCOUNT'}
//                     </button>
