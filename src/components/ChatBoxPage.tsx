...
// // // src/components/ChatboxPage.tsx
// // import React, { useState, useEffect } from 'react';
...
// //       {/* Programs Section - Now properly visible below chat */}
// //       <div className="programs-section">
// //         <div className="programs-container">
// //           <h2 className="programs-section-title">Wellness Programs</h2>
...
//                     <span>{program.availableDate}</span>
//                   </div>
//                   {/* Added Learn More link for consistency */}
...
const ChatboxPage: React.FC = () => {
  ...
  const ProgramCard: React.FC<{ program: ProgramCard }> = ({ program }) => {
      ...
      >
        ...
        <div className="program-card-image">
          <div 
            ...
            style={{ 
              backgroundImage: imageLoaded ? `url(${program.image})` : 'none',
